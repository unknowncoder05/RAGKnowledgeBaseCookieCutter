...
# Utilities
from ..conf import users_settings
from ..auth.external_token.providers import ExternalAuthenticationTokenProviders, send_token
from ..auth.external_token.token import random_token
from ..enums import ExternalAuthenticationTokenType
# Models
...
class ExternalAuthenticationToken(BaseModel):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='external_authentication_token',
...
def auth_sign_up_token_created(sender, instance, created, *args, **kwargs):
